...
class TopsControllerTest < ActionController::TestCase
  ...
  test "should create top" do
    assert_difference('Top.count') do
      post :create, top: { banner: @top.banner, contact: @top.contact, description: @top.description, email: @top.email, name: @top.name, phone: @top.phone }
    end
  ...
  test "should update top" do
    patch :update, id: @top, top: { banner: @top.banner, contact: @top.contact, description: @top.description, email: @top.email, name: @top.name, phone: @top.phone }
    assert_redirected_to top_path(assigns(:top))
  end
